...
export function VendorWorkOrdersEmptyState({ onCreate }: { onCreate: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center gap-4 rounded-lg border border-dashed border-border bg-surface p-12 text-center">
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-lg font-semibold text-foreground">No vendor work orders yet</h3>
        <p className="max-w-sm text-sm text-muted">
          Create a work order to assign a Vendor-type Cost Item to a supplier.
        </p>
      </div>
